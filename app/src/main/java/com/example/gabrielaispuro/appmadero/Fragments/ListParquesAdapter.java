 ...
 */
public class ListParquesAdapter extends BaseAdapter{
    ...
    public ListParquesAdapter(Context context, List<ParseObject> result, ArrayList<ParseObject> listImages){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ParseObject Parque = result.get(position);
        ParseObject imgParse = listImages.get(position);
        holder.txtTitulo.setText(Parque.getString("nombre"));
